<?php
require_once '../entidades/cruge_authassignment.entidad.php';
require_once '../models/cruge_authassignment.model.php';

// Logica
$cruge = new CrugeAuthassignment();
$model = new CrugeAuthassignmentModel();
?>
        ...
        <div>
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            <td><?php echo $r->__GET('userid'); ?></td>
                            <td><?php echo $r->__GET('bizrule'); ?></td>
                            <td><?php echo $r->__GET('data'); ?></td>
                            <td><?php echo $r->__GET('itemname'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
