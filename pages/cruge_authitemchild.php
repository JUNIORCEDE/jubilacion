<?php
require_once '../entidades/cruge_authitemchild.entidad.php';
require_once '../models/cruge_authitemchild.model.php';

// Logica
$cruge = new CrugeAuthitemChild();
$model = new CrugeAuthitemChildModel();
?>
        ...
        <div>
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            <td><?php echo $r->__GET('parent'); ?></td>
                            <td><?php echo $r->__GET('child'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
